...
export default function Home() {
  ...
  <div className="flex flex-col min-h-screen justify-center items-center relative z-10 max-w-6xl mx-auto px-4 py-6">
    ...
    <footer className="mt-8 pt-6 border-t border-gray-200 w-full max-w-4xl">
      <div className="flex flex-col items-center space-y-4">
        <div className="text-sm text-gray-600 font-medium">Connect with the developer</div>
